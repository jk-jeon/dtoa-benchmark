...
#pragma warning(disable : 4820 /* FOO bytes padding added                      \
  ...
  struct diy_fp {
    ...
    cxx14_constexpr diy_fp &
    operator=(const diy_fp &rhs) cxx11_noexcept = default;
    diy_fp() = default;
...
#pragma warning(pop)
  ...
  static diy_fp cached_power(const int in_exp2, int &out_exp10) cxx11_noexcept {
    ...
    static cxx11_constexpr_var short power10_exp2[] = {
        -1193, -1166, -1140, -1113, -1087, -1060, -1034, -1007, -980, -954,
        -927,  -901,  -874,  -847,  -821,  -794,  -768,  -741,  -715, -688,
        -661,  -635,  -608,  -582,  -555,  -529,  -502,  -475,  -449, -422,
        -396,  -369,  -343,  -316,  -289,  -263,  -236,  -210,  -183, -157,
        -130,  -103,  -77,   -50,   -24,   3,     30,    56,    83,   109,
        136,   162,   189,   216,   242,   269,   295,   322,   348,  375,
        402,   428,   455,   481,   508,   534,   561,   588,   614,  641,
        667,   694,   720,   747,   774,   800,   827,   853,   880,  907,
...
#define MODULO(x, y) x %= y
    ...
    do {
      ...
      case 0:
        ...
        early_skip:
          inout_exp10 += kappa;
          assert(kappa >= 0);
          return adjust(printer, delta, tail,
                        dec_power(unsigned(kappa)) << shift, gap, inout_exp10);
        }
  ...
  inline void convert(PRINTER &printer, diy_fp diy) cxx11_noexcept {
     ...
     */
    if (!printer.is_accurate() &&
        unlikely(diy.e >= -52 && diy.e <= lead_zeros) &&
